...
@extend_schema(
    ...
    description="Загружает новый файл в MinIO и сохраняет метаданные в MongoDB. Поддерживаемые форматы: JPEG, PNG, JPG.",
...
def upload_file(request):
    ...
    # ✅ Проверка MIME-типа (JPEG, PNG, JPG)
    ...
    if uploaded_file.content_type not in allowed_mimetypes:
        return JsonResponse({
            ...
            "received": uploaded_file.content_type
        }, status=400)
